...
- The Stitch exports have acquired adult supervision: every requested screen
  now maps to a real ASK route, state, adaptation, or explicit rejection, with
  truthful privacy copy and your words still requiring one deliberate
  `Use this` before they move.
