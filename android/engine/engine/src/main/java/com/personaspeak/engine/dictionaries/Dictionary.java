...
public abstract class Dictionary {
  ...
  /**
   * Table mapping most combined Latin, Greek, and Cyrillic characters to their base characters. If
  ...
  public abstract void getLoadedWords(GetWordsCallback callback);
  ...
  public interface WordCallback {
     ...
     * @param frequency the frequency of occurence. This is normalized between 1 and 255, but can
     *     exceed those limits
   ...
   */
  public abstract void getSuggestions(final KeyCodesProvider composer, final WordCallback callback);
  ...
  public void close() {
    Log.d(
        "Dictionary", "close called on '%s - %d'. Closed? %s", toString(), hashCode(), mClosed);
    ...
    synchronized (mResourceMonitor) {
      try {
        closeAllResources();
        Log.d("Dictionary", "closeAllResources done for '%s - %d'", toString(), hashCode());
      } catch (Exception e) {
        Log.w(
            "Dictionary",
            e,
  ...
  public void loadDictionary() {
    ...
    synchronized (mResourceMonitor) {
      try {
        ...
        Log.d("Dictionary", "loadDictionary called on '%s - %d'", toString(), hashCode());
        loadAllResources();
        Log.d("Dictionary", "loadDictionary done for '%s - %d'", toString(), hashCode());
      } finally {
