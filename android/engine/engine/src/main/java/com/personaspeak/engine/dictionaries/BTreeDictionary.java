...
public abstract class BTreeDictionary extends EditableDictionary {
  ...
  protected BTreeDictionary(String dictionaryName, int maxWordsToRead) {
    this(dictionaryName, maxWordsToRead, true);
  }

  protected BTreeDictionary(
      String dictionaryName, int maxWordsToRead, boolean includeTypedWord) {
    super(dictionaryName);
    mMaxWordsToRead = maxWordsToRead;
