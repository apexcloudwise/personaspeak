...
- ime/app/src/main/java/com/anysoftkeyboard/keyboards/views/KeyboardViewContainerView.java — generic single extension-row provider; sequential measurement above candidate/keyboard; strip actions remain on the candidate row; replay by reapplying the provider fields/API and two-pass layout.
- ime/app/src/test/java/com/anysoftkeyboard/keyboards/views/KeyboardViewContainerViewTest.java — added tests for generic extension row seam.
