...
- addons/languages/english/pack/build.gradle — askSourceRoot rewrite of the `addons/gradle/language_pack_lib.gradle` apply. No behavioral delta.
...
- ime/app/src/test/java/com/anysoftkeyboard/AnySoftKeyboardStartUpAllSdkTest.java — three shard `@Config` ranges repartitioned from [OLDEST-23][24-28][29-LATEST] to [26-29][30-32][33-LATEST(35)]: contiguous, non-overlapping, exhaustive over supported SDKs (minSdk 26); test bodies/assertions unchanged; unused `OLDEST_SDK` import removed. Executed counts post-change: 4/3/3 runs. Replay: keep shard union equal to [minSdk, LATEST_STABLE_API_LEVEL].
- ime/app/src/test/java/com/menny/android/anysoftkeyboard/AnyApplicationDeviceSpecificAllSdkTest.java — same shard repartition as above ([26-29][30-32][33-LATEST(35)]), bodies/assertions unchanged, unused import removed. Executed counts post-change: 4/3/3 runs. Replay: same rule.
