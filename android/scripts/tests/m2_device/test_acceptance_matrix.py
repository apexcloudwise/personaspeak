...
GOLDEN_CONTACTS = (    "adb: --version",    "emulator: --version",    "apksigner: --version",    "emulator: -list-avds",    "git: rev-parse HEAD",    "git: status --porcelain",    "emulator: -avd M2_Qual_Fixture -snapshot m2_pristine -no-snapshot-save -port 5554 -gpu swiftshader_indirect",    "adb: -s emulator-5554 wait-for-device",    "adb: -s emulator-5554 shell getprop sys.boot_completed",    "adb: -s emulator-5554 shell getprop ro.build.fingerprint",    "adb: -s emulator-5554 shell getprop ro.build.version.sdk",    "adb: -s emulator-5554 shell wm size",    "adb: -s emulator-5554 shell pm path biz.pixelperfectstudios.personaspeak",    "adb: -s emulator-5554 shell settings get secure enabled_input_methods",    "adb: -s emulator-5554 shell settings get secure default_input_method",    "adb: -s emulator-5554 shell getprop persist.sys.timezone",    "adb: -s emulator-5554 shell getprop ro.product.locale",    "adb: -s emulator-5554 shell getprop ro.product.cpu.abi",    "adb: -s emulator-5554 shell getprop qemu.sf.lcd_density",    "adb: -s emulator-5554 shell settings get global window_animation_scale",    "adb: -s emulator-5554 shell settings get global transition_animation_scale",    "adb: -s emulator-5554 shell settings get global animator_duration_scale",    "adb: -s emulator-5554 shell settings get secure default_input_method",    "apksigner: verify --print-certs <T>/mock_app.apk",    "adb: -s emulator-5554 install -r <T>/mock_app.apk",    "adb: -s emulator-5554 shell dumpsys package biz.pixelperfectstudios.personaspeak",    "adb: -s emulator-5554 shell screenrecord --time-limit 30 /sdcard/journey.mp4",    "adb: -s emulator-5554 shell ime enable biz.pixelperfectstudios.personaspeak/com.menny.android.anysoftkeyboard.SoftKeyboard",    "adb: -s emulator-5554 shell ime set biz.pixelperfectstudios.personaspeak/com.menny.android.anysoftkeyboard.SoftKeyboard",    "adb: -s emulator-5554 shell am start -a android.settings.SETTINGS",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/home_1.xml",    "adb: -s emulator-5554 shell input tap 540 659",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/focus_1.xml",    "adb: -s emulator-5554 shell dumpsys input_method",    "adb: -s emulator-5554 shell dumpsys window windows",    "adb: -s emulator-5554 shell input tap 81 2072",    "adb: -s emulator-5554 shell input tap 486 1794",    "adb: -s emulator-5554 shell input tap 270 1794",    "adb: -s emulator-5554 shell input tap 108 1932",    "adb: -s emulator-5554 shell input tap 567 2210",    "adb: -s emulator-5554 shell input tap 108 1932",    "adb: -s emulator-5554 shell input tap 486 1794",    "adb: -s emulator-5554 shell input tap 567 2210",    "adb: -s emulator-5554 shell input tap 216 1932",    "adb: -s emulator-5554 shell input tap 810 1794",    "adb: -s emulator-5554 shell input tap 324 2072",    "adb: -s emulator-5554 shell input tap 756 2210",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/typed_1.xml",    "adb: -s emulator-5554 shell screencap -p /sdcard/01-idle-typed.png",    "adb: -s emulator-5554 pull /sdcard/01-idle-typed.png <RUN>/artifacts/01-idle-typed.png",    "adb: -s emulator-5554 shell input tap 116 1452 ; input tap 180 1452",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/after_cancel.xml",    "adb: -s emulator-5554 shell dumpsys window windows",    "adb: -s emulator-5554 shell screencap -p /sdcard/02-loading-cancel.png",    "adb: -s emulator-5554 pull /sdcard/02-loading-cancel.png <RUN>/artifacts/02-loading-cancel.png",    "adb: -s emulator-5554 shell input keyevent 4 ; input keyevent 4",    "adb: -s emulator-5554 shell am start -a android.settings.SETTINGS",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/home_2.xml",    "adb: -s emulator-5554 shell input tap 540 659",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/focus_2.xml",    "adb: -s emulator-5554 shell dumpsys input_method",    "adb: -s emulator-5554 shell dumpsys window windows",    "adb: -s emulator-5554 shell input tap 81 2072",    "adb: -s emulator-5554 shell input tap 486 1794",    "adb: -s emulator-5554 shell input tap 270 1794",    "adb: -s emulator-5554 shell input tap 108 1932",    "adb: -s emulator-5554 shell input tap 567 2210",    "adb: -s emulator-5554 shell input tap 108 1932",    "adb: -s emulator-5554 shell input tap 486 1794",    "adb: -s emulator-5554 shell input tap 567 2210",    "adb: -s emulator-5554 shell input tap 216 1932",    "adb: -s emulator-5554 shell input tap 810 1794",    "adb: -s emulator-5554 shell input tap 324 2072",    "adb: -s emulator-5554 shell input tap 756 2210",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/typed_2.xml",    "adb: -s emulator-5554 shell input tap 116 1452",    "adb: -s emulator-5554 shell dumpsys window windows",    "adb: -s emulator-5554 shell screencap -p /sdcard/03-review.png",    "adb: -s emulator-5554 pull /sdcard/03-review.png <RUN>/artifacts/03-review.png",    "adb: -s emulator-5554 shell input tap 105 1452",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/after_apply.xml",    "adb: -s emulator-5554 shell screencap -p /sdcard/04-applied.png",    "adb: -s emulator-5554 pull /sdcard/04-applied.png <RUN>/artifacts/04-applied.png",    "adb: -s emulator-5554 shell input keyevent 4 ; input keyevent 4",    "adb: -s emulator-5554 shell am start -a android.settings.SETTINGS",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/home_3.xml",    "adb: -s emulator-5554 shell input tap 540 659",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/focus_3.xml",    "adb: -s emulator-5554 shell dumpsys input_method",    "adb: -s emulator-5554 shell dumpsys window windows",    "adb: -s emulator-5554 shell input tap 81 2072",    "adb: -s emulator-5554 shell input tap 486 1794",    "adb: -s emulator-5554 shell input tap 270 1794",    "adb: -s emulator-5554 shell input tap 108 1932",    "adb: -s emulator-5554 shell input tap 567 2210",    "adb: -s emulator-5554 shell input tap 108 1932",    "adb: -s emulator-5554 shell input tap 486 1794",    "adb: -s emulator-5554 shell input tap 567 2210",    "adb: -s emulator-5554 shell input tap 216 1932",    "adb: -s emulator-5554 shell input tap 810 1794",    "adb: -s emulator-5554 shell input tap 324 2072",    "adb: -s emulator-5554 shell input tap 756 2210",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/typed_3.xml",    "adb: -s emulator-5554 shell input tap 116 1452",    "adb: -s emulator-5554 shell dumpsys window windows",    "adb: -s emulator-5554 shell input tap 328 1452",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/after_dismiss.xml",    "adb: -s emulator-5554 shell dumpsys window windows",    "adb: -s emulator-5554 shell screencap -p /sdcard/05-dismissed.png",    "adb: -s emulator-5554 pull /sdcard/05-dismissed.png <RUN>/artifacts/05-dismissed.png",    "adb: -s emulator-5554 shell input keyevent 4 ; input keyevent 4",    "adb: -s emulator-5554 shell am start -a android.settings.SETTINGS",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/home_4.xml",    "adb: -s emulator-5554 shell input tap 540 659",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/focus_4.xml",    "adb: -s emulator-5554 shell dumpsys input_method",    "adb: -s emulator-5554 shell dumpsys window windows",    "adb: -s emulator-5554 shell input tap 81 2072",    "adb: -s emulator-5554 shell input tap 486 1794",    "adb: -s emulator-5554 shell input tap 270 1794",    "adb: -s emulator-5554 shell input tap 108 1932",    "adb: -s emulator-5554 shell input tap 567 2210",    "adb: -s emulator-5554 shell input tap 108 1932",    "adb: -s emulator-5554 shell input tap 486 1794",    "adb: -s emulator-5554 shell input tap 567 2210",    "adb: -s emulator-5554 shell input tap 216 1932",    "adb: -s emulator-5554 shell input tap 810 1794",    "adb: -s emulator-5554 shell input tap 324 2072",    "adb: -s emulator-5554 shell input tap 756 2210",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/typed_4.xml",    "adb: -s emulator-5554 shell input tap 116 1452",    "adb: -s emulator-5554 shell dumpsys window windows",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input keyevent 67",    "adb: -s emulator-5554 shell input tap 81 2072",    "adb: -s emulator-5554 shell input tap 486 1794",    "adb: -s emulator-5554 shell input tap 270 1794",    "adb: -s emulator-5554 shell input tap 108 1932",    "adb: -s emulator-5554 shell input tap 567 2210",    "adb: -s emulator-5554 shell input tap 108 1932",    "adb: -s emulator-5554 shell input tap 486 1794",    "adb: -s emulator-5554 shell input tap 567 2210",    "adb: -s emulator-5554 shell input tap 216 1932",    "adb: -s emulator-5554 shell input tap 270 1794",    "adb: -s emulator-5554 shell input tap 540 2072",    "adb: -s emulator-5554 shell input tap 270 1794",    "adb: -s emulator-5554 shell input tap 756 2072",    "adb: -s emulator-5554 shell input tap 756 2210",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/typed_stale.xml",    "adb: -s emulator-5554 shell input tap 105 1452",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/after_stale.xml",    "adb: -s emulator-5554 shell screencap -p /sdcard/06-stale.png",    "adb: -s emulator-5554 pull /sdcard/06-stale.png <RUN>/artifacts/06-stale.png",    "adb: -s emulator-5554 shell input keyevent 4 ; input keyevent 4",    "adb: -s emulator-5554 shell am start -a android.settings.SETTINGS",    "adb: -s emulator-5554 shell screencap -p /sdcard/07-settings.png",    "adb: -s emulator-5554 pull /sdcard/07-settings.png <RUN>/artifacts/07-settings.png",    "adb: -s emulator-5554 pull /sdcard/journey.mp4 <RUN>/artifacts/journey.mp4",    "adb: -s emulator-5554 emu avd snapshot load m2_pristine",    "adb: -s emulator-5554 shell getprop sys.boot_completed",    "adb: -s emulator-5554 shell getprop sys.boot_completed",    "adb: -s emulator-5554 shell getprop ro.build.fingerprint",    "adb: -s emulator-5554 shell getprop ro.build.version.sdk",    "adb: -s emulator-5554 shell wm size",    "adb: -s emulator-5554 shell pm path biz.pixelperfectstudios.personaspeak",    "adb: -s emulator-5554 shell settings get secure enabled_input_methods",    "adb: -s emulator-5554 shell settings get secure default_input_method",    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/verify_restore.xml",)


# argv of every ledgered command (normalized) + its kind token.
GOLDEN_LEDGER_ARGV = (    ('<BIN>/emulator', '-avd', 'M2_Qual_Fixture', '-snapshot', 'm2_pristine', '-no-snapshot-save', '-port', '5554', '-gpu', 'swiftshader_indirect', 'launch'),    ('<BIN>/adb', '-s', 'emulator-5554', 'wait-for-device', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'sys.boot_completed', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'ro.build.fingerprint', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'ro.build.version.sdk', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'wm', 'size', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'pm', 'path', 'biz.pixelperfectstudios.personaspeak', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'settings', 'get', 'secure', 'enabled_input_methods', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'settings', 'get', 'secure', 'default_input_method', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'persist.sys.timezone', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'ro.product.locale', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'ro.product.cpu.abi', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'qemu.sf.lcd_density', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'settings', 'get', 'global', 'window_animation_scale', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'settings', 'get', 'global', 'transition_animation_scale', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'settings', 'get', 'global', 'animator_duration_scale', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'settings', 'get', 'secure', 'default_input_method', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'install', '-r', '<T>/mock_app.apk', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'package', 'biz.pixelperfectstudios.personaspeak', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'ime', 'enable', 'biz.pixelperfectstudios.personaspeak/com.menny.android.anysoftkeyboard.SoftKeyboard', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'ime', 'set', 'biz.pixelperfectstudios.personaspeak/com.menny.android.anysoftkeyboard.SoftKeyboard', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'am', 'start', '-a', 'android.settings.SETTINGS', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/home_1.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '540', '659', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/focus_1.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'input_method', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'window', 'windows', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '81', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '486', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '270', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '108', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '567', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '108', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '486', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '567', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '216', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '810', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '324', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '756', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/typed_1.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'screencap', '-p', '/sdcard/01-idle-typed.png', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/01-idle-typed.png', '<RUN>/artifacts/01-idle-typed.png', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '116', '1452', ';', 'input', 'tap', '180', '1452', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/after_cancel.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'window', 'windows', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'screencap', '-p', '/sdcard/02-loading-cancel.png', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/02-loading-cancel.png', '<RUN>/artifacts/02-loading-cancel.png', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '4', ';', 'input', 'keyevent', '4', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'am', 'start', '-a', 'android.settings.SETTINGS', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/home_2.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '540', '659', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/focus_2.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'input_method', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'window', 'windows', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '81', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '486', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '270', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '108', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '567', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '108', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '486', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '567', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '216', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '810', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '324', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '756', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/typed_2.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '116', '1452', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'window', 'windows', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'screencap', '-p', '/sdcard/03-review.png', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/03-review.png', '<RUN>/artifacts/03-review.png', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '105', '1452', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/after_apply.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'screencap', '-p', '/sdcard/04-applied.png', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/04-applied.png', '<RUN>/artifacts/04-applied.png', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '4', ';', 'input', 'keyevent', '4', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'am', 'start', '-a', 'android.settings.SETTINGS', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/home_3.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '540', '659', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/focus_3.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'input_method', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'window', 'windows', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '81', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '486', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '270', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '108', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '567', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '108', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '486', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '567', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '216', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '810', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '324', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '756', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/typed_3.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '116', '1452', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'window', 'windows', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '328', '1452', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/after_dismiss.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'window', 'windows', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'screencap', '-p', '/sdcard/05-dismissed.png', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/05-dismissed.png', '<RUN>/artifacts/05-dismissed.png', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '4', ';', 'input', 'keyevent', '4', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'am', 'start', '-a', 'android.settings.SETTINGS', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/home_4.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '540', '659', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/focus_4.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'input_method', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'window', 'windows', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '81', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '486', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '270', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '108', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '567', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '108', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '486', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '567', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '216', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '810', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '324', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '756', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/typed_4.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '116', '1452', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'dumpsys', 'window', 'windows', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '67', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '81', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '486', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '270', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '108', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '567', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '108', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '486', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '567', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '216', '1932', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '270', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '540', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '270', '1794', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '756', '2072', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '756', '2210', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/typed_stale.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'tap', '105', '1452', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/after_stale.xml', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'screencap', '-p', '/sdcard/06-stale.png', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/06-stale.png', '<RUN>/artifacts/06-stale.png', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'input', 'keyevent', '4', ';', 'input', 'keyevent', '4', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'am', 'start', '-a', 'android.settings.SETTINGS', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'screencap', '-p', '/sdcard/07-settings.png', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/07-settings.png', '<RUN>/artifacts/07-settings.png', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'screenrecord', '--time-limit', '30', '/sdcard/journey.mp4', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/journey.mp4', '<RUN>/artifacts/journey.mp4', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'emu', 'avd', 'snapshot', 'load', 'm2_pristine', 'host'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'sys.boot_completed', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'sys.boot_completed', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'ro.build.fingerprint', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'getprop', 'ro.build.version.sdk', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'wm', 'size', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'pm', 'path', 'biz.pixelperfectstudios.personaspeak', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'settings', 'get', 'secure', 'enabled_input_methods', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'settings', 'get', 'secure', 'default_input_method', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'shell', 'uiautomator', 'dump', '/sdcard/window_dump.xml', 'shell'),    ('<BIN>/adb', '-s', 'emulator-5554', 'pull', '/sdcard/window_dump.xml', '<RUN>/artifacts/verify_restore.xml', 'host'),)


_STATE_FILES = (
    "edittext.state", "keyboard.state", "focus.state", "screen.state",
    "ime.state", "candidate_source.state",
    # #82 fake state: shift latch, BACK counter, boot-poll countdown.
    "shift.state", "back.state", "boot_polls_left.state",
)
_TOP_LEVEL_ALLOWED = {
...
class TestAcceptanceMatrix(unittest.TestCase):
    ...
    def _env(self, extra=None):
        env = {
            ...
            # #82 fake state: shift latch, BACK counter, boot-poll
            # countdown — pinned like every other state file so runs
            # never share residue through /tmp fallbacks.
    ...
    def test_matrix_wrapper_remote_nonzero_rc_propagates(self):
        ...
        self.assertEqual(step.operation, "focus_editor_1")
    ...
    def test_matrix_selector_duplication_fails_closed(self):
        ...
        # pick silently.
        result = self._run(
            {"FAKE_ADB_DUPLICATE": "open_search_view_edit_text"})
        self.assertNotEqual(result.returncode, 0)
        _, record = self._record()
        self._assert_common(record)
        step = self._last(record, "journey")
        self.assertEqual(step.cause, TerminalCause.JOURNEY_FAILED)
        self.assertTrue(
            step.operation in ("focus_editor_1", "verify_editor_pristine_1",
                               "verify_typed_1"),
    ...
    def test_matrix_combined_cleanup_failures(self):
        ...
        # The un-reset mutation that catches it: our IME stayed enabled
        # and selected after the failed snapshot load.
    ...
    def test_matrix_restore_settles_past_adbd_restart(self):
        # Defect H (#82), end-to-end: after the snapshot load adbd is
        # mid-restart, so the first two boot_completed polls draw rc 1
        # (the exact transient that killed dry-run iteration 3 at
        # verify_restore). The settle loop retries within its bound and
        # the run still completes cleanly.
        result = self._run({"FAKE_ADB_BOOT_POLLS": "2"})
        ...
        self.assertEqual(self._last(record, "restore").cause,
                         TerminalCause.COMPLETED)
        verify = self._last(record, "verify_restore")
        self.assertEqual(verify.cause, TerminalCause.COMPLETED)
        # One boot_completed contact before the journey (initial state)
        # plus three settle polls (two refused, one answered).
        self.assertGreaterEqual(
            self._contacts().count(
