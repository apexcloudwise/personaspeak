...
GOLDEN_CONTACTS = (
    ...
    "adb: -s emulator-5554 shell ime enable biz.pixelperfectstudios.personaspeak/com.menny.android.anysoftkeyboard.SoftKeyboard",
    "adb: -s emulator-5554 shell ime set biz.pixelperfectstudios.personaspeak/com.menny.android.anysoftkeyboard.SoftKeyboard",
    ...
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/home_1.xml",
    "adb: -s emulator-5554 shell input tap 540 659",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/focus_1.xml",
    "adb: -s emulator-5554 shell dumpsys input_method",
    "adb: -s emulator-5554 shell dumpsys window windows",
    "adb: -s emulator-5554 shell input tap 486 1794",
    "adb: -s emulator-5554 shell input tap 270 1794",
    "adb: -s emulator-5554 shell input tap 108 1932",
    "adb: -s emulator-5554 shell input tap 566 2210",
    "adb: -s emulator-5554 shell input tap 108 1932",
    "adb: -s emulator-5554 shell input tap 486 1794",
    "adb: -s emulator-5554 shell input tap 566 2210",
    "adb: -s emulator-5554 shell input tap 216 1932",
    "adb: -s emulator-5554 shell input tap 810 1794",
    "adb: -s emulator-5554 shell input tap 215 2072",
    "adb: -s emulator-5554 shell input tap 755 2210",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/typed_1.xml",
    ...
    "adb: -s emulator-5554 shell input tap 116 1452 ; input tap 180 1452",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/after_cancel.xml",
    "adb: -s emulator-5554 shell dumpsys window windows",
    ...
    "adb: -s emulator-5554 shell am start -a android.settings.SETTINGS",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/home_2.xml",
    "adb: -s emulator-5554 shell input tap 540 659",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/focus_2.xml",
    "adb: -s emulator-5554 shell dumpsys input_method",
    "adb: -s emulator-5554 shell dumpsys window windows",
    "adb: -s emulator-5554 shell input tap 486 1794",
    "adb: -s emulator-5554 shell input tap 270 1794",
    ...
    "adb: -s emulator-5554 shell input tap 755 2210",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/typed_2.xml",
    "adb: -s emulator-5554 shell input tap 116 1452",
    "adb: -s emulator-5554 shell dumpsys window windows",
    ...
    "adb: -s emulator-5554 shell input tap 105 1452",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    ...
    "adb: -s emulator-5554 shell am start -a android.settings.SETTINGS",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/home_3.xml",
    "adb: -s emulator-5554 shell input tap 540 659",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/focus_3.xml",
    "adb: -s emulator-5554 shell dumpsys input_method",
    "adb: -s emulator-5554 shell dumpsys window windows",
    "adb: -s emulator-5554 shell input tap 486 1794",
    "adb: -s emulator-5554 shell input tap 270 1794",
    ...
    "adb: -s emulator-5554 shell input tap 755 2210",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/typed_3.xml",
    "adb: -s emulator-5554 shell input tap 116 1452",
    "adb: -s emulator-5554 shell dumpsys window windows",
    "adb: -s emulator-5554 shell input tap 328 1452",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    ...
    "adb: -s emulator-5554 shell am start -a android.settings.SETTINGS",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/home_4.xml",
    "adb: -s emulator-5554 shell input tap 540 659",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/focus_4.xml",
    "adb: -s emulator-5554 shell dumpsys input_method",
    "adb: -s emulator-5554 shell dumpsys window windows",
    "adb: -s emulator-5554 shell input tap 486 1794",
    "adb: -s emulator-5554 shell input tap 270 1794",
    ...
    "adb: -s emulator-5554 shell input tap 755 2210",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/typed_4.xml",
    "adb: -s emulator-5554 shell input tap 116 1452",
    "adb: -s emulator-5554 shell dumpsys window windows",
    ...
    "adb: -s emulator-5554 shell input tap 216 1932",
    "adb: -s emulator-5554 shell input tap 270 1794",
    "adb: -s emulator-5554 shell input tap 431 2072",
    "adb: -s emulator-5554 shell input tap 270 1794",
    "adb: -s emulator-5554 shell input tap 647 2072",
    "adb: -s emulator-5554 shell input tap 755 2210",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
    "adb: -s emulator-5554 pull /sdcard/window_dump.xml <RUN>/artifacts/typed_stale.xml",
    "adb: -s emulator-5554 shell input tap 105 1452",
    "adb: -s emulator-5554 shell uiautomator dump /sdcard/window_dump.xml",
...
GOLDEN_LEDGER_ARGV = (
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "ime", "enable", "biz.pixelperfectstudios.personaspeak/com.menny.android.anysoftkeyboard.SoftKeyboard", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "ime", "set", "biz.pixelperfectstudios.personaspeak/com.menny.android.anysoftkeyboard.SoftKeyboard", "shell"],
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/home_1.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "540", "659", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/focus_1.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "input_method", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "window", "windows", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "486", "1794", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "270", "1794", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "108", "1932", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "566", "2210", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "108", "1932", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "486", "1794", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "566", "2210", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "216", "1932", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "810", "1794", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "215", "2072", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "755", "2210", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/typed_1.xml", "host"],
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "116", "1452", ";", "input", "tap", "180", "1452", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/after_cancel.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "window", "windows", "shell"],
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "keyevent", "4", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "am", "start", "-a", "android.settings.SETTINGS", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/home_2.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "540", "659", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/focus_2.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "input_method", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "window", "windows", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "486", "1794", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "270", "1794", "shell"],
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "755", "2210", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/typed_2.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "116", "1452", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "window", "windows", "shell"],
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "105", "1452", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "am", "start", "-a", "android.settings.SETTINGS", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/home_3.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "540", "659", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/focus_3.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "input_method", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "window", "windows", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "486", "1794", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "270", "1794", "shell"],
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "755", "2210", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/typed_3.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "116", "1452", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "window", "windows", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "328", "1452", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "am", "start", "-a", "android.settings.SETTINGS", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/home_4.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "540", "659", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/focus_4.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "input_method", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "window", "windows", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "486", "1794", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "270", "1794", "shell"],
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "755", "2210", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/typed_4.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "116", "1452", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "dumpsys", "window", "windows", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "keyevent", "67", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "keyevent", "67", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "keyevent", "67", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "keyevent", "67", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "keyevent", "67", "shell"],
    ...
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "216", "1932", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "270", "1794", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "431", "2072", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "270", "1794", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "647", "2072", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "755", "2210", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "pull", "/sdcard/window_dump.xml", "<RUN>/artifacts/typed_stale.xml", "host"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "input", "tap", "105", "1452", "shell"],
    ["<BIN>/adb", "-s", "emulator-5554", "shell", "uiautomator", "dump", "/sdcard/window_dump.xml", "shell"],
