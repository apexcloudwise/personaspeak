...
android {
    ...
    defaultConfig {
        // PersonaSpeak second-host branding: defaults to the pristine
        // upstream id; the PersonaSpeak evaluation build passes
...
dependencies {
    ...
    // PersonaSpeak second-host layer: host-neutral IME graph + panel UI.
    implementation(project(":personaspeak-ime"))
    implementation(project(":personaspeak-ui"))
    // Direct deps needed because personaspeak-ime uses implementation for
    // these; the glue reads PersonaId/Mood and OpenRouterModels directly.
