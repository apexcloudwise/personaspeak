...
| 5 — onboarding and settings | The Stitch welcome, enable/select, provider/key, guided real-ASK demo, persona, provider, privacy, appearance, and inherited typing settings are complete. Review-before-replace remains fixed behavior. | Fresh-install guided-demo recording, navigation tests, and screen captures. |
