...
| 5 — onboarding and settings | The Stitch welcome, enable/select, provider/key, guided real-ASK demo, persona, provider, rewrite, privacy, appearance, and inherited typing settings are complete. | Fresh-install guided-demo recording, navigation tests, and screen captures. |
